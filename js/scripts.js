...
$(document).ready(function(){
    $('form#address').submit(function(){
        ...
        var location = $('input#estate').val();
        var house= $('input#hse').val();
        var phone= $('input#phone').val();
        if ($('input#Name').val() && $('input#estate').val() && $('input#hse').val() && $('input#phone').val() !== ""){
            alert(" "+Name+" your order will be delivered at "+estate+" House N0. "+house+" .");
        } else {
...
function myFunction() {
    var order;
    if (confirm("Delivery Fee = Ksh 150")) {
      txt = "You pressed OK!";
    } else {
      txt = "You pressed Cancel!";
    }
      document.getElementById("payments").innerHTML = order;
      }
